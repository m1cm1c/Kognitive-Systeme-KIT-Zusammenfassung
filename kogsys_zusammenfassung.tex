...
\documentclass[10pt,a4paper,german,twoside]{book}
...
\include{kapitel/02_bildverarbeitung}
\include{kapitel/03_klassifikation}
\include{kapitel/04_spracherkennung}
\include{kapitel/05_maschinelles_lernen}
\include{kapitel/06_3d-bildverarbeitung}
\include{kapitel/07_visuelle_wahrnehmung}
\include{kapitel/08_wissen_und_planung}
\include{kapitel/09_wiederholungsfragen}
